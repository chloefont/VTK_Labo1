...
public:
    ...
    Matrix(const Vec3f& p) {
        static_assert(rows==4 and cols==1, "Initialisation from Vec3f only works for Matrix<4,1>");
...
template<class T>
Vec3<T>::Vec3(const VecH& h) : x(h[0][0]/h[0][3]), y(h[0][1]/h[0][3]), z(h[0][2]/h[0][3]) { }
